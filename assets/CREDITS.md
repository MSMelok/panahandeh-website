...
All photography sourced from **Pexels** under the [Pexels License](https://www.pexels.com/license/) — free for commercial use, no attribution required. Credited here as good practice.

These are stand-ins for the client's own product photography.

| File | Photographer | Source |
|---|---|---|
| hero.webp | Engin Akyurt | https://www.pexels.com/photo/vibrant-saffron-spice-close-up-display-33654800/ |
| chickpeas.webp | Engin Akyurt | https://www.pexels.com/photo/close-up-of-fresh-chickpeas-in-bulk-29060109/ |
| lentils.webp | Eva Bronzini | https://www.pexels.com/photo/close-up-shot-of-lentils-6086414/ |
| splitpeas.webp | Jagdeep Singh | https://www.pexels.com/photo/yellow-split-beans-16599820/ |
| saffron.webp | Victoria Bowers | https://www.pexels.com/photo/red-saffron-spice-on-brown-wooden-spoon-10487658/ |
| kidneybeans.webp | Arina Krasnikova | https://www.pexels.com/photo/overhead-shot-of-beans-6316702/ |
...
Source files kept in `brand/`: `ravoma-mark-source.png` (transparent monogram),
`ravoma-logo-full-source.png` (full lockup), `ravoma-brand-board-source.png` (brand board).

RAVOMA is the product brand printed on the packs. The trading entity is Panahandeh Foodstuff
Trading L.L.C — see the note at the top of the README.

## A note on the spice photography

Every "cumin" result available under the Pexels licence was either caraway seed or a styled
spoon shot, so the fourth spice line is **coriander seed** rather than cumin. If the client
trades cumin and wants it on the site, it needs a real photograph — substituting caraway
would be mislabelling a traded commodity.
